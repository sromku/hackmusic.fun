...
export default function HostRoom({ code }: { code: string }) {
  ...
  useEffect(() => {
    if (!participantId || !hostKey || !partyStatus || partyStatus === "ended") return;
    let active = true;
  ...
  }, [code, getSpotifyToken, hostKey, participantId, partyStatus]);
