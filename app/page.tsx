  ...
  return (
    <main className="landing-shell">
      ...
      <footer className="landing-footer">
        ...
        <nav aria-label="Site links"><a href="/go-bigger">Go bigger</a><a href="https://github.com/sromku/hackmusic.fun" target="_blank" rel="noreferrer">Open source ↗</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a></nav>
